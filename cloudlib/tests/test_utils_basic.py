...
class TestBasicUtils(unittest.TestCase):
    def test_is_int_is_int(self):
        self.assertTrue(isinstance(basic.is_int(value=1), int))

    def test_is_int_is_str(self):
        self.assertTrue(isinstance(basic.is_int(value='string'), str))

    def test_ensure_string_unicode(self):
        self.assertTrue(isinstance(basic.ensure_string(obj=u'test'), str))

    def test_ensure_string_str(self):
        self.assertTrue(isinstance(basic.ensure_string(obj='test'), str))

    def test_ensure_dict_update(self):
        test = {'test': 'value'}
        test_update = {'other': 'value'}
        return_dict = basic.dict_update(
